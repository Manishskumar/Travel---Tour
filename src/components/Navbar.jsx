...
export default function Navbar() {
    const [dropdown, setDropdopwn]= useState(false);

     const showDropdown = () => {
        setDropdopwn(!dropdown);
     };
    return(
        <nav className="w-full h-24 flex-col justify-center items-center lg:bg-transparent bg-[url('/1.jpg')] bg-cover lg:relative fixed z-20 ">
            <div className="container mx-auto lg:px-6">
                <div className="lg:w-full w-11/12 mx-auto h-full flex justify-between items-center">
                    <div className="fllex flex-col gap-y-4 lg:w-1/3">
                    ...
                    <ul className="flex-1 flex justify-center items-center gap-16 max-lg:hidden">
                        ...
                        <a href="#" className="leading-normal text-lg no-underline text-white">Golrious</a>
                ...
                {dropdown ? (
                    <div
                        onClick={showDropdown} className="lg:hidden w-full h-full fixed top-24 bg-[url('/1.jpg')] bg-cover ease-in-out duration-100">
                        <div className="w-full h-[320px] flex flex-col items-baseline pt-8 gap-4">
                            <ul className="text-center p-0 flex-col justify-center w-full gap-y-8">
                            <a href="#" className="leading-normal text-lg no-underline text-white">Home</a>
                            <a href="#" className="leading-normal text-lg no-underline text-white">Explore</a>
                            <a href="#" className="leading-normal text-lg no-underline text-white">Articles</a>
                            <a href="#" className="leading-normal text-lg no-underline text-white">Golrious</a>
